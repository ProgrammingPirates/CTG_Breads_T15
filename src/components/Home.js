    ...
    if (this.state.status === "home") {
      return <div>
        <nav class="navbar navbar-light" style={{ backgroundColor: "white" }}>
          <div style={{ paddingLeft: "2%" }}><a class="navbar-brand" href="#"><div style={{ fontSize: "1.5rem", color: "black", fontWeight: "bolder" }}><span style={{ color: "#00308F" }}>Breads</span></div></a></div>
        </nav>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12" style={{ textAlign: "center" }}>
              <div style={{ paddingTop: "5%" }}></div>
              <h1 style={{ fontWeight: "bolder" }}>Welcome to <span style={{ color: "#00308F" }}>breads</span>Portal!</h1>
...
<button class = "buttonLink"><a href = "#" target="_blank"><img src="https://img.icons8.com/fluent/48/000000/github.png"/></a></button>{ "   "}
<button class = "buttonLink"><a href = "#" target="_blank"><img src="https://img.icons8.com/ios-filled/48/000000/medium-logo.png"/></a></button>{ "   "}
<button class = "buttonLink"><a href = "#" target="_blank"><img src="https://img.icons8.com/fluent/48/000000/linkedin.png"/></a></button>{ "   "}
<button class = "buttonLink"><a href = "#" target="_blank"><img src="https://img.icons8.com/color/48/000000/gmail.png"/></a></button>{ "   "}
</div>
<h1 style={{color:"white", fontWeight:"bolder"}}><span style={{ color: "#00308F" }}>Breads</span>Portal</h1>
</div>
</div>
      </div>
    }
