            ...
            if (this.state.level === "Going Good") {
                return <div style={{ textAlign: "center" }}>
                    <nav class="navbar navbar-light" style={{ backgroundColor: "white" }}>
                        <div style={{ paddingLeft: "2%" }}><a class="navbar-brand" href="#"><div style={{ fontSize: "1.5rem", color: "black", fontWeight: "bolder" }}><span style={{ color: "#00308F" }}>Breads</span></div></a></div><button class=  "button1" onClick = {(e) => {this.logout(e)}}>Logout</button>
                    </nav>
        ...
        if (this.state.status === "view") {
            if (this.state.level === "Going Good") {
                return <div class="container" style={{ textAlign: "center" }}>
                    <nav class="navbar navbar-light" style={{ backgroundColor: "white" }}>
                        <div style={{ paddingLeft: "2%" }}><a class="navbar-brand" href="#"><div style={{ fontSize: "1.5rem", color: "black", fontWeight: "bolder" }}><span style={{ color: "#00308F" }}>Breads</span></div></a></div><button class = "button1" onClick = {(e) => {e.preventDefault(); this.setState({status: "back"})}}>Go Back</button>
                    </nav>
