        ...
        <div class="doc-profile Appointment-detail  bg-white rounded-3 h-100 p-3">
            ...
            <div class="mt-3">
                ...
                <div class="d-flex justify-content-between">
                    <button class="btn" id="prev" disabled>{{__('Prev')}}</button>
                    <button class="btn" id="next">{{__('Next')}}</button>
                    <a href="javascript:void(0)" id="payment" onclick="report_book()" class="btn d-none">{{__('Proceed To Pay')}}</a>
                </div>
            </div>
            <!-- Stapper Over -->
        </div>
