                ...
                <div class="col-lg-6">
                    <div class="schedule bg-white rounded-3 h-100 ">
                        <div class="d-flex align-items-center border-bottom p-3">
                            ...
                            <h6 class="ms-2">{{ __('Counsellor Availablity') }}</h6>
                        </div>
                ...
                <div class="py-2 bg-white rounded-2">
                    <div class="single-nav">
                        <ul class="d-flex justify-content-center border-bottom">
                            <li class="d-flex text-center active"><a href="javascript:void(0)" onclick="seeData('#doctor_information')" class="h-100 w-100">{{ __('Counsellor Information') }}</a></li>
