    ...
    <section class="section">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                  <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                        <h6 class="text-muted">{{__('Counsllors')}}</h6>
                      </div>
                      <div class="card-body">
                        <h3>{{ $totalDoctors }}</h3>
                      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-6">
              <div class="card card-chart">
                  <div class="card-header">
                      <h4 class="card-title">{{__('Counsellor - Student')}}</h4>
                  </div>
                  <div class="card-body">
      ...
      <div class="row">
          <div class="col-md-6 d-flex">
              <div class="card card-table flex-fill">
                  <div class="card-header">
                      <h4 class="card-title">{{__('Counsellor List')}}</h4>
                  </div>
                  <div class="card-body">
          ...
          <div class="col-md-6 d-flex">
              <div class="card  card-table flex-fill">
                  <div class="card-header">
                      <h4 class="card-title">{{__('Latest Student List')}}</h4>
                  </div>
                  <div class="card-body">
                      <div class="table-responsive">
