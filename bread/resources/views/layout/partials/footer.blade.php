    ...
    <div class="content mx-auto">
        <div class="pb-5">
            <div class="row g-0">
                ...
                <img src="{{ $setting->companyWhite }}" height="60px" class="" alt="">

                </div>
                <div class=" col-lg-3 col-md-4 ps-3 pb-4 col-sm-6  ">
                    <div>
                        <h6>{{__('For Student')}}</h6>
                    </div>
                    <div class="mt-4">
                        <ul class="nav mt-3 footer-nav flex-column">
                            <li class="nav-item">
                                <a href="{{ url('show-doctors') }}">{{__('Counsellor')}}</a>
                            </li>
                            @if (auth()->check())
                                <li class="nav-item">
        ...
        <div class="d-flex">
            <div class="mx-auto d-flex flex-column align-items-center">
                {{-- <img src="{{ $setting->companyWhite }}" height="60px" class="" alt=""> --}}
                <p>{{__('Copyright')}} &copy; {{ Carbon\Carbon::now(env('timezone'))->year }} <p>Breads</p>{{__('All rights reserved')}} </p>
            </div>
        </div>
    </div>
</div>