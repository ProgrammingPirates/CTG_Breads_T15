        ...
        <div class="container-xl">
            ...
            <div class="content mx-auto my-3 our_doctor">
                <div class="d-flex w-100 describe justify-content-between flex-sm-row flex-column py-3 align-items-sm-center">
                    <div class="consult ml-2">
                        <h2><?php echo e(__('Our Counsellor')); ?></h2>
                    </div>
            ...
            <div class="content mx-auto my-5">
                <div class="text-center mb-5">
                    <h3><?php echo e(__('Read top articles from Counsellors')); ?></h3>
                </div>
...
<?php echo $__env->make('layout.mainlayout',['active_page' => 'home'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doctro\resources\views/website/home.blade.php ENDPATH**/ ?>