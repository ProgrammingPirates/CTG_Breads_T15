<?php $__env->startSection('title',__('Doctor Register')); ?>
      ...
      <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
        <div class="p-4 m-3">
          ...
          <img src="<?php echo e($app_logo->logo); ?>" alt="logo" width="180" class="mb-5 mt-2">
            ...
            <?php endif; ?>
            <form action="<?php echo e(url('doctor/doctor_register')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"  name="name" value="<?php echo e(old('name')); ?>" type="name">
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" type="email">
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <input type="number" value="<?php echo e(old('phone')); ?>" name="phone" class="form-control">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="password"><?php echo e(__('Date of birth')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label for="password"><?php echo e(__('Gender')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group text-right">
                    <span class="float-left"><?php echo e(__("already have an account?")); ?><a href="<?php echo e(url('doctor/doctor_login')); ?>"><?php echo e(__(' Login')); ?></a></span>
                    <button class="btn btn-primary btn-lg btn-icon icon-right" type="submit"><?php echo e(__('Sign Up')); ?></button>
                </div>
            </form>
            <div class="login-or">
...
<?php echo $__env->make('layout.mainlayout_admin',['activePage' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doctro\resources\views/doctor/auth/doctor_register.blade.php ENDPATH**/ ?>