...
<?php $__env->startSection('title', __('Admin login')); ?>
        ...
        <div class="d-flex flex-wrap align-items-stretch">
            <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                <div class="p-4 m-3">
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(url('admin/verify_admin')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group text-right">
                            <a href="<?php echo e(url('admin_forgot_password')); ?>" class="float-left mt-3">
                    ...
                    <div class="mt-3 d-flex justify-content-between">
                        <a href="<?php echo e(url('doctor/doctor_login')); ?>"><?php echo e(__('Counsellor Login')); ?></a>
...
<?php echo $__env->make('layout.mainlayout_admin',['activePage' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doctro\resources\views/superAdmin/auth/login.blade.php ENDPATH**/ ?>