                ...
                <div class="row mb-5">
                    <div class="col">
                        <ul class="nav nav-tabs nav-tabs-solid">
                            <li class="nav-item">
                                <a class="nav-link active" href="blog"><?php echo e(__('Acitive Blog')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('blog/pending-blog')); ?>"><?php echo e(__('Pending Blog')); ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php echo $__env->make('layout.mainlayout_admin',['activePage' => 'blog'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\doctro\resources\views/superAdmin/blog/blog.blade.php ENDPATH**/ ?>